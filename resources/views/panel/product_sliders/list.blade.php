      ...
      <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
                  ...
                  <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                      ...
                      <div class="card-title">
                        ...
                        <a href="/admin/product_sliders/create" class="btn btn-sm fw-bold btn-primary" >ساختن</a>
                        @endif
                      </div>
										</div>
										<!--end::Header-->
                        ...
                        @endif
                            ...
                            @foreach($sliders as $slider)
                              ...
                              <td>
                                ...
                                <a href="{{route('admin.product_sliders.index')}}/{{$slider->id}}/edit" class="btn text-warning btn-bg-light btn-active-color-primary btn-sm me-1">
...
<script>
  $('body').on('click', '.delete-confirm', function() {
      ...
      var route = "{{route('admin.product_sliders.index')}}/"+id;
