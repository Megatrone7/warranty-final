						...
						<div class="d-flex flex-column flex-column-fluid">
							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">ویرایش صفحه</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
							...
							<div id="kt_app_content" class="app-content flex-column-fluid">
								...
								<div id="kt_app_content_container" class="app-container container-xxl">
									<!--begin::Form-->
									<form id="kt_ecommerce_add_product_form" method="post" action="{{route('admin.pages.index')}}/{{$page->id}}" class="form d-flex flex-column flex-lg-row" enctype="multipart/form-data">
                    {{method_field('put')}}
                    @csrf
                    <!--begin::کناری column-->
                                ...
                                @if(session('success'))
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="mb-10 fv-row col-12" dir="rtl">
                                      ...
                                      <textarea name='text' class="tox-target">{!!$page->text!!}</textarea>
    																</div>
...
<script>
  $('[name="title"]').val('{{$page->title}}');
  $('[name="status"]').val('{{$page->status}}');
  $('[name="creator_id"]').val('{{$page->creator_id}}');
