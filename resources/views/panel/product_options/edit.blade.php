						...
						<div class="d-flex flex-column flex-column-fluid">
							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">ویرایش تنوع محصول</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
							...
							<div id="kt_app_content" class="app-content flex-column-fluid">
								...
								<div id="kt_app_content_container" class="app-container container-xxl">
									<!--begin::Form-->
									<form id="kt_ecommerce_add_product_form" method="post" action="{{route('admin.product_options.index')}}/{{$option->id}}" class="form d-flex flex-column flex-lg-row" enctype="multipart/form-data">
                    {{method_field('put')}}
                    @csrf
                    <!--begin::کناری column-->
                      ...
                      <div class="tab-content">
                                ...
                                <div class="row">
                                  ...
                                  <div class="mb-10 fv-row col-3">
                                    ...
                                    <select disabled class="form-control" name='product_id' required>
                                  ...
                                  <div class="mb-10 fv-row col-3">
                                    ...
                                    <select disabled class="form-control" name='color_id' required>
                                  ...
                                  <div class="mb-10 fv-row col-3">
                                    ...
                                    <select disabled class="form-control" name='size_id' required>
                                  ...
                                  <div class="mb-10 fv-row col-3">
                                    ...
                                    <select disabled class="form-control" name='warranty_id' required>
...
<script>
  $('[name="product_id"]').val('{{$option->product_id}}');
  $('[name="color_id"]').val('{{$option->color_id}}');
  $('[name="size_id"]').val('{{$option->size_id}}');
  $('[name="warranty_id"]').val('{{$option->warranty_id}}');
  $('[name="price"]').val('{{$option->price}}');
  $('[name="count"]').val('{{$option->count}}');
  $('[name="status"]').val('{{$option->status}}');
  $('[name="text"]').val('{{$option->text}}');
