						...
						<div class="d-flex flex-column flex-column-fluid">
							...
							<div id="kt_app_content" class="app-content flex-column-fluid">
								...
								<div id="kt_app_content_container" class="app-container container-xxl">
									<!--begin::Form-->
									<form id="kt_ecommerce_add_product_form" method="post" action="{{ route('warranty.update',	 $warranty->id )}}" class="form d-flex flex-column flex-lg-row" enctype="multipart/form-data">
                    {{method_field('put')}}
                    @csrf
                    <!--begin::کناری column-->
                                ...
                                <div class="row">
                                  ...
                                  <div class="mb-10 fv-row col-4">
																  ...
																  <div class="mb-10 fv-row col-4">
  																	...
  																	<input type="date" name="expire_time" class="form-control mb-2" value=""/>
  																</div>
																  <div class="mb-10 fv-row col-4">
  																	<label class="form-label">دسته بندی	</label>
  																	<input type="text" name="product_category" class="form-control mb-2" value=""/>
  																</div>	
                                </div>
																<!--begin::Input group-->
...
<script>
  ...
  $('[name="title"]').val('{{$warranty->title}}');
  $('[name="type"]').val('{{$warranty->type}}');
  $('[name="length"]').val('{{$warranty->length}}');
  $('[name="serial_number"]').val('{{$warranty->serial_number}}');
  $('[name="status"]').val('{{$warranty->status}}');
  $('[name="expire_time"]').val('{{$warranty->expire_time}}');
  $('[name="product_category"]').val('{{$warranty->product_category}}');
