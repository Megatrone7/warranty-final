                                ...
                                <div class="card mb-5 mb-xl-8">
                                            ...
                                            <div class="d-flex align-items-center position-relative my-1">
                                                ...
                                                <span class="svg-icon svg-icon-1 position-absolute ms-4">
                                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                        ...
                                                        <rect opawarranties="0.5" x="17.0365" y="15.1223"
                                            ...
                                            <div class="card-toolbar">
                                                @can('isAdmin')
                                                    <a href="{{ route('warranty.create') }}"
                                                        class="btn btn-sm fw-bold btn-primary">ساختن</a>
                                                @endcan
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body py-3">
                                        ...
                                        <div class="table-responsive">
                                            <!--begin::Table-->
                                            <table
                                                class="table datatable1 text-center table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
                                                <!--begin::Table head-->
                                                <thead>
                                                    <tr class="fw-bold text-muted">
                                                        ...
                                                        <th class="min-w-100px text-center">صاحب</th>
														<th class="min-w-100px text-center">گزینه ها</th>
                                                    </tr>
                                                </thead>
                                                <!--end::Table head-->
                                                <!--begin::Table body-->
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                @can('isAdmin')
                                                                    ...
                                                                    <a href="{{ route('warranty.edit', $warranties->id) }}"
