                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                          ...
                          <span class="svg-icon svg-icon-1 position-absolute ms-4">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <rect opawarranties="0.5" x="17.0365" y="15.1223" width="8.15546" height="2" rx="1" transform="rotate(45 17.0365 15.1223)" fill="currentColor" />
												...
												<table class="table datatable1 text-center table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
													...
													<thead>
														<tr class="fw-bold text-muted">
															...
															<th
															<th 
															class="min-w-100px text-center">عملیات</th>
														</tr>
													</thead>
													<!--end::Table head-->
													<!--begin::Table body-->
