...
<div class="d-flex flex-column flex-root app-root" id="kt_app_root">
  ...
  <div class="app-page flex-column flex-column-fluid" id="kt_app_page">
    ...
    <div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
      ...
      <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
                  ...
                  <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">لیست مدیران</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
                      ...
                      <div class="card-title">
                        ...
                        <a href="{{route('admins.create')}}" class="btn btn-sm fw-bold btn-primary" >ساختن</a>
    ...
    @method('DELETE')
																<button type="submit" class="btn text-danger btn-bg-light btn-active-color-primary btn-sm delete-confirm" id='delete-{{$user->id}}'/>
                                ...
                                <a href="{{ route('admins.edit',  $user->id) }}" class="btn text-warning btn-bg-light btn-active-color-primary btn-sm me-1">
