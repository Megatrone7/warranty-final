    ...
    <div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
      ...
      <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
                  ...
                  <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">لیست استان ها</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
                      ...
                      <div class="card-title">
                        ...
                        @if(Gate::allows('states-create'))
                        <a href="/admin/states/create" class="btn btn-sm fw-bold btn-primary" >ساختن</a>
                        @endif
											</div>
										</div>
										<!--end::Header-->
                            ...
                            @foreach($states as $state)
                              ...
                              <td>
                                ...
                                @if(Gate::allows('states-delete'))
																<a  class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm delete-confirm" id='delete-{{$state->id}}'>
                                ...
                                @if(Gate::allows('states-update'))
                                <a href="{{route('admin.states.index')}}/{{$state->id}}/edit" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                ...
                                @if(Gate::allows('state_cities-list'))
                                <a href="{{route('admin.states.index')}}/{{$state->id}}/cities" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
																	<!--begin::Svg Icon | path: icons/duotune/art/art005.svg-->
																	<span class="svg-icon svg-icon-3">
...
<script>
  $('body').on('click', '.delete-confirm', function() {
      ...
      var route = "{{route('admin.states.index')}}/"+id;
