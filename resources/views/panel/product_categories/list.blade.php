...
<div class="d-flex flex-column flex-root app-root" id="kt_app_root">
  ...
  <div class="app-page flex-column flex-column-fluid" id="kt_app_page">
      ...
      <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
                  ...
                  <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                      ...
                      <div class="card-title">
                        ...
                        <a href="{{route('category.create')}}" class="btn btn-sm fw-bold btn-primary" >ساختن</a>
												<!--begin::جستجو-->
    ...
    @method('DELETE')
																<button type="submit" class="btn text-danger btn-bg-light btn-active-color-primary btn-sm delete-confirm" id='delete-{{$category->id}}'/>
...
<script>
  $('body').on('click', '.delete-confirm', function() {
      ...
      var route = "{{route('category.index')}}/"+id;
