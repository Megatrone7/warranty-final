      ...
      <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
                  ...
                  <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                      ...
                      <div class="card-title">
                        ...
                        @if(Gate::allows('footer_menus-create'))
                          @if($parent=="")
                            <a href="/admin/footer_menus/create" class="btn btn-sm fw-bold btn-primary" >ساختن</a>
                          @else
                            <a href="/admin/footer_menus/{{$parent->id}}/childrens/create" class="btn btn-sm fw-bold btn-primary" >ساختن</a>
                          @endif
                        @endif
                      </div>
										</div>
                            ...
                            @foreach($menus as $menu)
                              ...
                              <td>
                                ...
                                @endif
															...
															<td>
                                @if(Gate::allows('footer_menus-delete'))
                                ...
                                @if(Gate::allows('footer_menus-update'))
                                <a href="{{route('admin.footer_menus.index')}}/{{$menu->id}}/edit" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                ...
                                @if($parent=="")
                                <a href="{{route('admin.footer_menus.index')}}/{{$menu->id}}/childrens" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
																	<!--begin::Svg Icon | path: icons/duotune/art/art005.svg-->
																	<span class="svg-icon svg-icon-3">
...
<script>
  $('body').on('click', '.delete-confirm', function() {
      ...
      var route = "{{route('admin.footer_menus.index')}}/"+id;
