      ...
      <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
                  ...
                  <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                      ...
                      <div class="card-title">
                        ...
                        @if(Gate::allows('header_menus-create'))
                          @if($parent=="")
                            <a href="/admin/header_menus/create" class="btn btn-sm fw-bold btn-primary" >ساختن</a>
                          @else
                            <a href="/admin/header_menus/{{$parent->id}}/childrens/create" class="btn btn-sm fw-bold btn-primary" >ساختن</a>
                          @endif
                        @endif
                      </div>
										</div>
                            ...
                            @foreach($menus as $menu)
                              ...
                              <td>
                                ...
                                @endif
															...
															<td>
                                @if(Gate::allows('header_menus-delete'))
                                ...
                                @if(Gate::allows('header_menus-update'))
                                <a href="{{route('admin.header_menus.index')}}/{{$menu->id}}/edit" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                ...
                                <a href="{{route('admin.header_menus.index')}}/{{$menu->id}}/childrens" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
																	<!--begin::Svg Icon | path: icons/duotune/art/art005.svg-->
																	<span class="svg-icon svg-icon-3">
...
<script>
  $('body').on('click', '.delete-confirm', function() {
      ...
      var route = "{{route('admin.header_menus.index')}}/"+id;
