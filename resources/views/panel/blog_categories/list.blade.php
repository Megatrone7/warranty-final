      ...
      <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
                  ...
                  <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                      ...
                      <div class="card-title">
                        ...
                        @if(Gate::allows('blog_categories-create'))
                          @if($parent=="")
                            <a href="/admin/blog_categories/create" class="btn btn-sm fw-bold btn-primary" >ساختن</a>
                          @else
                            <a href="/admin/blog_categories/{{$parent->id}}/childrens/create" class="btn btn-sm fw-bold btn-primary" >ساختن</a>
                          @endif
                        @endif
                      </div>
										</div>
                            ...
                            @foreach($categories as $category)
                              ...
                              <td>
                                ...
                                @endif
															...
															<td>
                                @if(Gate::allows('blog_categories-delete'))
																<a  class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm delete-confirm" id='delete-{{$category->id}}'>
                                ...
                                @if(Gate::allows('blog_categories-update'))
                                <a href="{{route('admin.blog_categories.index')}}/{{$category->id}}/edit" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                ...
                                @if($parent=="")
                                <a href="{{route('admin.blog_categories.index')}}/{{$category->id}}/childrens" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
																	<!--begin::Svg Icon | path: icons/duotune/art/art005.svg-->
																	<span class="svg-icon svg-icon-3">
...
<script>
  $('body').on('click', '.delete-confirm', function() {
      ...
      var route = "{{route('admin.blog_categories.index')}}/"+id;
