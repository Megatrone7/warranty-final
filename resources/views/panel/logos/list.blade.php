      ...
      <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
                  ...
                  <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                      ...
                      <div class="card-title">
                        ...
                        @if(Gate::allows('logos-create'))
                        <a href="/admin/logos/create" class="btn btn-sm fw-bold btn-primary" >ساختن</a>
                        @endif
                      </div>
										</div>
										<!--end::Header-->
                            ...
                            @foreach($logos as $logo)
                              ...
                              <td>
                                ...
                                @endif
															...
															<td>
                                @if(Gate::allows('logso-delete'))
																<a  class="btn text-danger btn-bg-light btn-active-color-primary btn-sm delete-confirm" id='delete-{{$logo->id}}'>
                                ...
                                @if(Gate::allows('logos-update'))
                                <a href="{{route('admin.logos.index')}}/{{$logo->id}}/edit" class="btn text-warning btn-bg-light btn-active-color-primary btn-sm me-1">
                                ...
                                <a href="{{$logo->image}}" target="_blank" class="btn text-success btn-bg-light btn-active-color-primary btn-sm me-1">
																	<!--begin::Svg Icon | path: icons/duotune/art/art005.svg-->
																	نمایش
																	<!--end::Svg Icon-->
																</a>
...
<script>
  $('body').on('click', '.delete-confirm', function() {
      ...
      var route = "{{route('admin.logos.index')}}/"+id;
