      ...
      <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
                  ...
                  <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                      ...
                      <div class="card-title">
                        ...
                        @if(Gate::allows('faqs-create'))
                        <a href="/admin/faqs/create" class="btn btn-sm fw-bold btn-primary" >ساختن</a>
                        @endif
                      </div>
										</div>
										<!--end::Header-->
                            ...
                            @foreach($faqs as $faq)
                              ...
                              <td>
                                ...
                                @endif
															...
															<td>
                                @if(Gate::allows('faqs-delete'))
                                <a  class="btn text-danger btn-bg-light btn-active-color-primary btn-sm delete-confirm" id='delete-{{$faq->id}}'>
                                ...
                                @if(Gate::allows('faqs-update'))
                                <a href="{{route('admin.faqs.index')}}/{{$faq->id}}/edit" class="btn text-warning btn-bg-light btn-active-color-primary btn-sm me-1">
                                ...
                                <a href="{{route('admin.faqs.index')}}/{{$faq->id}}/questions" class="btn text-primary btn-bg-light btn-active-color-primary btn-sm me-1">
																	<!--begin::Svg Icon | path: icons/duotune/art/art005.svg-->
																	سوالات
																	<!--end::Svg Icon-->
																</a>
...
<script>
  $('body').on('click', '.delete-confirm', function() {
      ...
      var route = "{{route('admin.faqs.index')}}/"+id;
