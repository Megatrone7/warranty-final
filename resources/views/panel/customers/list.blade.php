    ...
    <div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
      ...
      <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
                  ...
                  <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">لیست مشتریان</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
                      ...
                      <div class="card-title">
                        ...
                        <a href="/admin/customers/create" class="btn btn-sm fw-bold btn-primary" >ساختن</a>
                        @endif
											</div>
										</div>
										<!--end::Header-->
                            ...
                            @foreach($customers as $customer)
                              ...
                              <td>
                                ...
                                @endif
															...
															<td>
                                @if(Gate::allows('customers-delete'))
																<a  class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm delete-confirm" id='delete-{{$customer->id}}'>
                                ...
                                <a href="{{route('admin.customers.index')}}/{{$customer->id}}/edit" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
