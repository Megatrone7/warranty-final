    ...
    <div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
      ...
      <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
                  ...
                  <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">لیست برند ها</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
                      ...
                      <div class="card-title">
                        ...
                        @if(Gate::allows('product_brands-create'))
                        <a href="/admin/brands/create" class="btn btn-sm fw-bold btn-primary" >ساختن</a>
                        @endif
											</div>
										</div>
										<!--end::Header-->
												...
												<table class="table datatable1 text-center table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
													...
													<thead>
														<tr class="fw-bold text-muted">
															...
															<th class="min-w-140px text-center">عنوان فارسی</th>
                              <th class="min-w-140px text-center">عنوان انگلیسی</th>
                            ...
                            @foreach($brands as $brand)
                              ...
                              <td>
                                ...
                                @endif
															...
															<td>
                                @if(Gate::allows('product_brands-delete'))
																<a  class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm delete-confirm" id='delete-{{$brand->id}}'>
                                ...
                                @if(Gate::allows('product_brands-update'))
                                <a href="{{route('admin.brands.index')}}/{{$brand->id}}/edit" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
...
<script>
  $('body').on('click', '.delete-confirm', function() {
      ...
      var route = "{{route('admin.brands.index')}}/"+id;
