      ...
      <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
                  ...
                  <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                      ...
                      <div class="card-title">
                        ...
                        @if(Gate::allows('sliders-create'))
                        <a href="/admin/sliders/create" class="btn btn-sm fw-bold btn-primary" >ساختن</a>
                        @endif
                      </div>
										</div>
										<!--end::Header-->
                            ...
                            @foreach($sliders as $slider)
                              ...
                              <td>
                                ...
                                @endif
															...
															<td>
                                @if(Gate::allows('sliders-delete'))
																<a  class="btn text-danger btn-bg-light btn-active-color-primary btn-sm delete-confirm" id='delete-{{$slider->id}}'>
                                ...
                                @if(Gate::allows('sliders-update'))
                                <a href="{{route('admin.sliders.index')}}/{{$slider->id}}/edit" class="btn text-warning btn-bg-light btn-active-color-primary btn-sm me-1">
                                ...
                                <a href="{{$slider->image}}" target="_blank" class="btn text-success btn-bg-light btn-active-color-primary btn-sm me-1">
																	<!--begin::Svg Icon | path: icons/duotune/art/art005.svg-->
																	نمایش
																	<!--end::Svg Icon-->
																</a>
...
<script>
  $('body').on('click', '.delete-confirm', function() {
      ...
      var route = "{{route('admin.sliders.index')}}/"+id;
