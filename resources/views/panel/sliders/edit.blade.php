						...
						<div class="d-flex flex-column flex-column-fluid">
							...
							<div id="kt_app_content" class="app-content flex-column-fluid">
								...
								<div id="kt_app_content_container" class="app-container container-xxl">
									<!--begin::Form-->
									<form id="kt_ecommerce_add_product_form" method="post" action="{{route('admin.sliders.index')}}/{{$slider->id}}" class="form d-flex flex-column flex-lg-row" enctype="multipart/form-data">
                    {{method_field('put')}}
                    @csrf
                    <!--begin::کناری column-->
                      ...
                      <div class="tab-content">
                                ...
                                <div class="d-flex justify-content-end">
                                  <!--begin::Button-->
                                  <a href="/admin/sliders"  class="btn btn-light me-5">بازگشت</a>
                                  <!--end::Button-->
                                  <!--begin::Button-->
...
<script>
  ...
  $('[name="link"]').val('{{$slider->link}}');
  $('[name="link_type"]').val('{{$slider->link_type}}');
