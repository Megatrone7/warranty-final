                        ...
                        @endif
                            ...
                            @foreach($banners as $banner)
                              ...
                              <td>
                                ...
                                @if(Gate::allows('banners-update'))
                                <a href="{{route('admin.banners.index')}}/{{$banner->id}}/edit" class="btn text-warning btn-bg-light btn-active-color-primary btn-sm me-1">
                                ...
                                <a href="{{$banner->image}}" target="_blank" class="btn text-success btn-bg-light btn-active-color-primary btn-sm me-1">
																	<!--begin::Svg Icon | path: icons/duotune/art/art005.svg-->
																	نمایش
																	<!--end::Svg Icon-->
																</a>
