    ...
    <div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
      ...
      <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
                  ...
                  <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">گزارشات ورود</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
												...
												<table class="table datatable1 text-center table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
													...
													<thead>
														<tr class="fw-bold text-muted">
															...
															<th class="min-w-140px text-center">کاربر</th>
															<th class="min-w-120px text-center">آی پی</th>
...
<script>
  $('body').on('click', '.delete-confirm', function() {
      ...
      var route = "{{route('admin.admins.index')}}/"+id;
