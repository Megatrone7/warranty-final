      ...
      <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
                  ...
                  <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                      ...
                      <div class="card-title">
                        ...
                        @if(Gate::allows('transports-create'))
                        <a href="/admin/transports/create" class="btn btn-sm fw-bold btn-primary" >ساختن</a>
                        @endif
                      </div>
										</div>
										<!--end::Header-->
                            ...
                            @foreach($transports as $transport)
                              ...
                              <td>
                                ...
                                @endif
															...
															<td>
                                @if(Gate::allows('transports-delete'))
																<a  class="btn text-danger btn-bg-light btn-active-color-primary btn-sm delete-confirm" id='delete-{{$transport->id}}'>
                                ...
                                @if(Gate::allows('transports-update'))
                                <a href="{{route('admin.transports.index')}}/{{$transport->id}}/edit" class="btn text-warning btn-bg-light btn-active-color-primary btn-sm me-1">
                                ...
                                @if(Gate::allows('transport_prices-list'))
                                <a href="{{route('admin.transports.index')}}/{{$transport->id}}/prices" class="btn text-primary btn-bg-light btn-active-color-primary btn-sm me-1">
																	<!--begin::Svg Icon | path: icons/duotune/art/art005.svg-->
																	قیمت ها
																	<!--end::Svg Icon-->
																</a>
...
<script>
  $('body').on('click', '.delete-confirm', function() {
      ...
      var route = "{{route('admin.transports.index')}}/"+id;
