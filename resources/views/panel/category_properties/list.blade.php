    ...
    <div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
      ...
      <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
                  ...
                  <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                      ...
                      ویژگی های دسته بندی {{$category->title}}
                      ...
                      <div class="card-title">
                        ...
                        @if(Gate::allows('category_properties-create'))
                        <a href="/admin/product_categories/{{$category->id}}/properties/create" class="btn btn-sm fw-bold btn-primary" >ساختن</a>
                        @endif
                      </div>
										</div>
										<!--end::Header-->
                            ...
                            @foreach($properties as $property)
                              ...
                              <td>
                                ...
                                @endif
															...
															<td>
                                @if(Gate::allows('category_properties-delete'))
																<a  class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm delete-confirm" id='delete-{{$property->id}}'>
                                ...
                                @if(Gate::allows('category_properties-update'))
                                <a href="{{route('admin.product_categories.index')}}/{{$category->id}}/properties/{{$property->id}}/edit" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
...
<script>
  $('body').on('click', '.delete-confirm', function() {
      ...
      var route = "{{route('admin.product_categories.index')}}/{{$category->id}}/properties/"+id;
