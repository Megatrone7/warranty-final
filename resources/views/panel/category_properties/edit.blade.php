						...
						<div class="d-flex flex-column flex-column-fluid">
							...
							<div id="kt_app_content" class="app-content flex-column-fluid">
								...
								<div id="kt_app_content_container" class="app-container container-xxl">
									<!--begin::Form-->
									<form id="kt_ecommerce_add_product_form" method="post" action="{{route('admin.product_categories.index')}}/{{$category->id}}/properties/{{$property->id}}" class="form d-flex flex-column flex-lg-row">
                    {{method_field('put')}}
                    @csrf
                    <!--begin::کناری column-->
                      ...
                      <div class="tab-content">
                                ...
                                <div class="d-flex justify-content-end">
                                  <!--begin::Button-->
                                  <a href="/admin/product_categories/{{$category->id}}/properties" id="kt_ecommerce_add_product_cancel" class="btn btn-light me-5">بازگشت</a>
                                  <!--end::Button-->
                                  <!--begin::Button-->
...
<script>
  $('[name="title"]').val('{{$property->title}}');
  $('[name="status"]').val('{{$property->status}}');
</script>
@endsection
