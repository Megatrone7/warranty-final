						...
						<div class="d-flex flex-column flex-column-fluid">
							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">ویرایش مطلب</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
							...
							<div id="kt_app_content" class="app-content flex-column-fluid">
								...
								<div id="kt_app_content_container" class="app-container container-xxl">
									<!--begin::Form-->
									<form id="kt_ecommerce_add_product_form" method="post" action="{{route('admin.blogs.index')}}/{{$blog->id}}" class="form d-flex flex-column flex-lg-row" enctype="multipart/form-data">
                    {{method_field('put')}}
                    @csrf
                    <!--begin::کناری column-->
                      ...
                      <div class="tab-content">
                                ...
                                <div class="row">
                                  ...
                                  <div class="mb-10 fv-row col-6">
                                    ...
                                    <select class="form-control" data-control="select2" name='category_id' data-placeholder="انتخاب کنید" required>
                                      <option selected disabled value="">انتخاب کنید</option>
                                  ...
                                  <div class="mb-10 fv-row col-12" dir="rtl">
                                    ...
                                    <textarea name='text' class="tox-target">{!!$blog->text!!}</textarea>
  																</div>
                                ...
                                <div class="d-flex justify-content-end">
                                  <!--begin::Button-->
                                  <a href="/admin/blogs"  class="btn btn-light me-5">بازگشت</a>
                                  <!--end::Button-->
                                  <!--begin::Button-->
...
<script>
  ...
  $('[name="category_id"]').val('{{$blog->category_id}}');
  $('[name="creator_id"]').val('{{$blog->creator_id}}');
  ...
  $(document).ready(function(){
    ...
    tinymce.init({
        ...
        image_advtab: true,
        images_upload_url: '/panel/upload?type=blog',
        relative_urls: false,
      }).then(function() {
