      ...
      <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
						...
						<div class="d-flex flex-column flex-column-fluid">
							...
							<div class="app-toolbar py-3 py-lg-6">
								...
								<div class="app-container container-xxl d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">افزودن مطلب</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
							...
							<div class="app-content flex-column-fluid">
								...
								<div class="app-container container-xxl">
									<!--begin::Form-->
									<form method="post" action="{{route('admin.blogs.store')}}" class="form d-flex flex-column flex-lg-row" enctype="multipart/form-data">
                    @csrf
                    ...
                    <!--begin::کناری column-->
                                ...
                                <div class="row">
                                  ...
                                  <div class="mb-10 fv-row col-12">
  																	<label class="required form-label">تصویر شاخص</label>
