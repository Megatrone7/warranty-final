    ...
    <div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
      ...
      <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
                  ...
                  <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">لیست کد تخفیف ها</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
                      ...
                      <div class="card-title">
                        ...
                        @if(Gate::allows('discounts-create'))
                        <a href="/admin/discounts/create" class="btn btn-sm fw-bold btn-primary" >ساختن</a>
                        @endif
											</div>
										</div>
										<!--end::Header-->
                            ...
                            @foreach($discounts as $discount)
                              ...
                              <td>
                                ...
                                @endif
															...
															<td>
                                @if(Gate::allows('discounts-delete'))
																<a  class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm delete-confirm" id='delete-{{$discount->id}}'>
                                ...
                                @if(Gate::allows('discounts-update'))
                                <a href="{{route('admin.discounts.index')}}/{{$discount->id}}/edit" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
...
<script>
  $('body').on('click', '.delete-confirm', function() {
      ...
      var route = "{{route('admin.discounts.index')}}/"+id;
